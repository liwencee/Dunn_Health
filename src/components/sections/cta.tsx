...
export function CTASection() {
  return (
    ...
    >
      <style>{`
        .cta-btn-white { background:#fff; color:var(--pink-dark); padding:0.9rem 2.5rem; border-radius:4px; font-weight:800; font-size:0.95rem; letter-spacing:0.06em; text-transform:uppercase; text-decoration:none; transition:all 0.3s; display:inline-block; box-shadow:0 8px 30px rgba(0,0,0,0.15); }
      ...
      <div className="container" style={{ position: "relative", zIndex: 1, textAlign: "center" }}>
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
          ...
          <p style={{ color: "rgba(255,255,255,0.9)", fontSize: "1.1rem", maxWidth: 600, margin: "0 auto 2.5rem", lineHeight: 1.7 }}>
            Scheduling your first appointment is simple. I&apos;m ready to listen, support, and walk alongside you every step of the way.
          </p>
          <div style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap" }}>
            <Link href="/contact" className="cta-btn-white">Book Appointment</Link>
            <a href="tel:+19128485335" className="cta-btn-outline-white">📞 Call Now</a>
          </div>
          <p style={{ color: "rgba(255,255,255,0.7)", fontSize: "0.85rem", marginTop: "1.5rem" }}>
            CareSource GA · Amerigroup GA · Self-Pay · Telehealth Available Statewide
          </p>
        </motion.div>
      </div>
    </section>
